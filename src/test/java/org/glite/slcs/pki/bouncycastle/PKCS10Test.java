...
public class PKCS10Test extends TestCase {
     ...
     */
    public void no_testX509Principal() {
        X509Principal p1 = createX509Principal("CN=A+B");
        System.out.println("X509Principal=" + p1);
        assertEquals("CN=A\\+B", p1.toString());

    	X509Principal p2 = createX509Principal("DC=hello,CN=A+CN=B");
        System.out.println("X509Principal=" + p2);
    ...
    private X509Extensions createX509Extensions() {
        ...
        extensions.put(X509Extension.keyUsage, keyUsageExtension);
        ...
        extensions.put(X509Extension.extendedKeyUsage,
        ...
        extensions.put(X509Extension.certificatePolicies,
        ...
        extensions.put(X509Extension.subjectAlternativeName,
